...
[![Build Status](https://img.shields.io/badge/Status-In_Progress-orange)](https://github.com/abdullahsadik00/Learning-chunk)
[![Level](https://img.shields.io/badge/SDE-Level_2-blue)](https://github.com/abdullahsadik00/Learning-chunk)
...
- [**/basics**](./basics): Core language fundamentals, asynchronous programming, and logic.
- [**/frontend**](./frontend): UI/UX implementation, styling frameworks, and client-side logic.
- [**/backend**](./backend): Server-side architecture, API design, and middleware implementation.
- [**/database**](./database): Schema design, SQL/NoSQL mastery, and query optimization.
- [**/docs**](./docs): Architecture notes, templates, and interview prep.
...
| :--- | :--- | :--- | :--- |
| **Week 1** | JS Fundamentals | [`/basics/week-1`](./basics/week-1) | Async/Await, File I/O, Callbacks |
| **Week 2** | Advanced JS | [`/basics/week-2`](./basics/week-2) | Promises, HOFs, Classes, JS Refreshers |
...
This is a personal learning log, but feedback and PRs are welcome if you find a bug in the implementations. Please follow the [README Template](./docs/README_TEMPLATE.md) for any new contributions.
...
---
*Built with ❤️ by [Sadik](https://github.com/abdullahsadik00)*
