      ...
      <header className="border-b border-slate-800 sticky top-0 z-10 bg-slate-900/95 backdrop-blur">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-4">
          <Link
            ...
            className="text-slate-500 hover:text-slate-300 transition text-sm flex-shrink-0"
          >
            ← Dashboard
          </Link>
          <h1 className="font-semibold text-white">Event explorer</h1>
          {isFetching && !isLoading && (
            <span className="text-xs text-slate-500 ml-auto">Updating…</span>
          )}
        </div>
      </header>
